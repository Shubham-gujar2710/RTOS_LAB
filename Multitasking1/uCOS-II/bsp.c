...
#define  GPIO0_INT3             DEF_BIT_30   /* Added by Mangesh */
...
#define  GPIO0_AVIN             DEF_BIT_28
                                                                ...
                                                                /* ---------------------- GPIO1 Pins ---------------------- */
#define  GPIO1_LED1             DEF_BIT_04    /* changed by Mangesh */
#define  GPIO1_LED2             DEF_BIT_05
#define  GPIO1_LED3             DEF_BIT_06
#define  GPIO1_LED4             DEF_BIT_07
#define  GPIO1_LED5             DEF_BIT_08
#define  GPIO1_LED6             DEF_BIT_09
#define  GPIO1_LED7             DEF_BIT_10
#define  GPIO1_LED8             DEF_BIT_11
...
//  PINSEL2  |= 0x00000008;                                     /* The pins P1.25-16 will be used as a Trace port.          */
    ...
    PINSEL0  = 0x00000000;
    IO0DIR  &= ~GPIO0_INT3;                                     /* External INT button      */
    IO0DIR  |=  GPIO1_LEDS;                                     /* LEDs                                                     */
    PINSEL2  |= 0x00000004;                                     /* The pins P1.36-26 will be used as a Debug port.          */
...
void Uart_Init(unsigned int baudrate)      //setting the baud rate for 115200 baud
{
 int i,FDiv;
...
void  LED_Toggle (CPU_INT08U led)
{
    ...
    switch (led) {
        case 0:
             are_off = ( ~(IO0PIN ^ GPIO1_LEDS) & GPIO1_LEDS);
             are_on  = ( (IO0PIN ^ GPIO1_LEDS) & GPIO1_LEDS);
             //IO0CLR =  are_on;
             //IO0SET =  are_off;
             IO0CLR =  are_off;
             IO0SET =  are_on;
